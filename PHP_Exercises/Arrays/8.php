Viết một tập lệnh PHP để sắp xếp mảng kết hợp sau: Đi tới trình chỉnh sửa
mảng ("Sophia" => "31", "Jacob" => "41", "William" => "39", "Ramesh" => "40") trong
a) sắp xếp thứ tự tăng dần theo giá trị
b) sắp xếp thứ tự tăng dần theo Khóa
c) sắp xếp thứ tự giảm dần theo Giá trị
d) sắp xếp thứ tự giảm dần theo Khóa

                            ...
                            <form class="form-horizontal" method="post" action="">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="TenTL" name="TenTL" class="form-control" maxlength="20" minlength="3" required placeholder="Nhập tên thể loại">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="TenTL_KhongDau" name="TenTL_KhongDau" class="form-control" placeholder="Nhập Tên TL Không Dấu">
                                            </div>
                                        </div>
                                    </div>
                                </div>

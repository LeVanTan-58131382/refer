<?php
    ...
    if(isset($_POST["Ten"]))
    {
        ...
        $qt->LoaiTin_Them($Ten, $Ten_KD, $ThuTu, $AnHien, $lang, $idTL);
                            ...
                            <form class="form-horizontal" method="post" action="">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="Ten" name="Ten" class="form-control" maxlength="20" minlength="3" required placeholder="Nhập tên loại tin">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="Ten_KhongDau" name="Ten_KhongDau" class="form-control" placeholder="Nhập Tên Loại Tin Không Dấu">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" id="ThuTu" name="ThuTu" class="form-control" placeholder="Nhập thứ tự"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="radio" id="AH1" name="AnHien" checked="checked" value="1">
                                                <label for="AH1" >Hiện</label>
                                                <input type="radio" id="AH0" name="AnHien" checked="checked" value="0">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="radio" id="vi" name="lang" checked="checked" value="vi">
                                                <label for="vi" >Tiếng Viêt</label>
                                                <input type="radio" id="en" name="lang" checked="checked" value="en">

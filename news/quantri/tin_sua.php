<?php
    ...
    if(isset($_POST["TieuDe"]))
    {
        ...
        $qt->Tin_Sua($TD, $TD_KD, $TT, $Ngay, $AnHien, $TNB, $idTL, $idLT, $urlHinh, $ND, $lang, $idTin);
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="TieuDe" required maxlength="100" minlength="10" value="<?= $row['TieuDe'] ?>">
                                        
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="TieuDe_KhongDau" required value="<?= $row['TieuDe_KhongDau'] ?>">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                       <textarea class="form-control" name="TomTat" cols="30" rows="5">
                                            <?= $row["TomTat"] ?>
                                       </textarea>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                             <input type="radio" name="AnHien" id="AH0" value="0" class="form-control" <?= ($row["AnHien"] == 0) ? "checked" : "" ?>>
                                             <label for="AH0" >Ẩn</label>
                                             <input type="radio" name="AnHien" id="AH1" value="1" class="form-control" <?= ($row["AnHien"] == 1) ? "checked" : "" ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                             <input type="radio" name="TinNoiBat" id="TNB0" value="0" class="form-control" <?= ($row["TinNoiBat"] == 0) ? "checked" : "" ?>>
                                             <label for="TNB0" >Tin Thường</label>
                                             <input type="radio" name="TinNoiBat" id="TNB1" value="1" class="form-control" <?= ($row["TinNoiBat"] == 1) ? "checked" : "" ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                             <input type="radio" name="lang" id="vi" value="vi" class="form-control" <?= ($row["lang"] == "vi") ? "checked" : "" ?>>
                                             <label for="vi" >Tiếng Việt</label>
                                             <input type="radio" name="lang" id="en" value="en" class="form-control" <?= ($row["lang"] == "en") ? "checked" : "" ?>>
                                ...
                                <div class="row clearfix">
                                    <div class=" col-md-12 ">
                                        <div class="form-group form-float">
                                            <div class="form-line ">
                                                <input type="text" class="datepicker" name="Ngay" placeholder="Ngày đăng" value="<?=  date('d/m/Y', strtotime($row["Ngay"]))  ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea id="NoiDungTin" name="NoiDungTin" cols="30" rows="5" class="form-control" placeholder="Nội dung tin" required>
                                        <?= $row["Content"] ?>
                                        </textarea>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    <input type="text" name="urlHinh" id="urlHinh" class="form-control" name="password" value="<?= $row['urlHinh'] ?>"
                                ...
                                <button class="btn btn-primary waves-effect" type="submit">SỬA TIN</button>
                            </form>
                        </div>
                    </div>
                </div>

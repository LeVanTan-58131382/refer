                                    ...
                                    <tbody>
                                        ...
                                        <?php while($rowTL = $kq ->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?p=theloai_sua&idTL=<?= $rowTL["idTL"] ?>" class="btn bg-blue 
                                                    waves-effect">Cập nhật</a> &nbsp

                                                    <a href="theloai_xoa.php?idTL=<?= $rowTL["idTL"] ?>" class="btn bg-red 
                                                    waves-effect" onclick="return confirm('Xóa thật hã')">Xóa</a>

                                                    <!-- <a href="theloai_xoa&idTL=" class="btn bg-red 
                                                    waves-effect" onclick="return confirm('Xóa thật hã')">Xóa</a> -->
                                                </td>
                                            </tr>
                                        <?php } ?>

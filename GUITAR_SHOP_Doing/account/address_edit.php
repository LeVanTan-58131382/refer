       ...
       <div class="noidungcon">
              ...
              <div id="edit_address_form">
                     <form action="." method="post">
                            ...
                            <label>Address:</label>
                            <input type="text" name="line1" value="<?php echo htmlspecialchars($line1); ?>">
                            <?php echo $fields->getField('line1')->getHTML(); ?><br>

                            <label>Line 2:</label>
                            <input type="text" name="line2" value="<?php echo htmlspecialchars($line2); ?>">
                            ...
                            <label>&nbsp;</label>
                            <input type="submit" value="<?php echo htmlspecialchars($heading); ?>">
                            <br>
                     </form>
                     <form action="." method="post">
                            <label>&nbsp;</label>
